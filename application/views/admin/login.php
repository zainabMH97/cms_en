                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Login with Denetro Dashboard</span>
                                    </h6>
                                </div>
                                ...
                                <?php endif; ?>              
                                        ...
                                        <?php echo form_open('admin/checkAdmin'); ?>
                                ...
                                <div class="card-footer">
                                    <div class="">
                                        <!-- <p class="float-xl-left text-center m-0"><a href="forgetPassword" class="card-link">Forget
                                                password</a></p> -->
                                    </div>
                                </div>
