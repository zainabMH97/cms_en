                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card box-shadow-0" style="padding: 30px;">
                                ...
                                <h2><?php echo $this->lang->line('tags-editinfo-title'); ?></h2>
                                ...
                                <?php echo form_open_multipart('tags/updateTagInfo'); ?>
                                <input type="hidden" name="id" value="<?php echo $info[0]['term_id']; ?>">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('tags-editinfo-name'); ?></label>
                                        <input type="text" class="form-control" name="title"  placeholder="Enter title" value="<?php echo $info[0]['term_title']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('tags-editinfo-Description'); ?></label>
